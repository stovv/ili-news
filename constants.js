...
export const YANDEX_METRIKA = {
    accounts: process.env.NEXT_PUBLIC_YANDEX_METRIKA_ACCOUNTS.split(',').map(account=>Number(account)),
    options: { webvisor: process.env.NEXT_PUBLIC_YANDEX_METRIKA_WEBVISOR }
};
